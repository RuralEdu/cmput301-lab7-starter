...
// You can also use anything() in place of is(instanceOf(String.class))
    ...
    public void testActivitySwitch() {
        ...
        onView(withId(R.id.backActivityButton)).check(matches(isDisplayed()));
    }

    @Test
    public void testSameCityName() {

        onView(withId(R.id.button_add)).perform(click());
        onView(withId(R.id.editText_name)).perform(ViewActions.typeText("Indianapolis"));
        onView(withId(R.id.button_confirm)).perform(click());

        onData(is("Indianapolis")).inAdapterView(withId(R.id.city_list)).perform(click());
        onView(withId(R.id.cityNameTextView)).check(matches(withText("Indianapolis")));
    }

    @Test
    public void testBackButton() {
        onView(withId(R.id.button_add)).perform(click());
        onView(withId(R.id.editText_name)).perform(ViewActions.typeText("San Antonio"));
        onView(withId(R.id.button_confirm)).perform(click());

        onData(is("San Antonio")).inAdapterView(withId(R.id.city_list)).perform(click());
        onView(withId(R.id.backActivityButton)).perform(click());
        onView(withId(R.id.backActivityButton)).check(doesNotExist());
